...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const specialtyBlock = document.getElementById("specialty_block");
  ...
  if (city) {
    ...
    // Специальность
    setBlockVisible(specialtyBlock, !noHigher);

    if (specialty) {
        specialty.required = !noHigher;
        if (noHigher) specialty.value = "";
    }
    }
